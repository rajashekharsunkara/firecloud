...
class SignalingClient {
  ...
  static const defaultServerUrl = 'https://signal.firecloud.app';
  static const _defaultTurnRelayBase = 'https://relay.firecloud.app';
    ...
    try {
      await _dio.post<void>(
        ...
        data: jsonEncode({
          ...
          'public_url': _publicIp == null ? null : 'http://$_publicIp:${_publicPort ?? nodePort}',
          'local_port': nodePort,
          ...
          'nat_type': _natType,
          'relay_urls': [
            '$_defaultTurnRelayBase/p2p/${identity.deviceId}',
          ],
        }),
      );
